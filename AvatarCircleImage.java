package ru.rocket.robot.taxi777.ui.custom;
...
import ru.rocket.robot.taxi777.R;

/**
 * Created RATMIR on 01.04.2018.
 * Copyright © Ratmir
 */
...
public class AvatarCircleImage extends ImageView {
    ...
    public AvatarCircleImage(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.AvatarCircleImage_civ_border_width, DEFAULT_BORDER_WIDTH);
        borderColor = a.getColor(R.styleable.AvatarCircleImage_civ_border_color, DEFAULT_BORDER_COLOR);
        borderOverlay = a.getBoolean(R.styleable.AvatarCircleImage_civ_border_overlay, DEFAULT_BORDER_OVERLAY);
